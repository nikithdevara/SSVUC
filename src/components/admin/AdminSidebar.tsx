  ...
  const navItems: NavItem[] = [
    {
      ...
      requiredRole: ['DEVELOPER', 'SUPER_ADMIN', 'TREASURER'],
    },
    {
      label: 'Offerings',
    ...
    },
    {
      ...
      icon: Bell,
      requiredRole: ['DEVELOPER', 'SUPER_ADMIN', 'COMMITTEE_ADMIN', 'TREASURER'],
    },
    {
      label: 'Devotee Messages',
      route: '/admin/messages',
      icon: Mail,
      requiredRole: ['DEVELOPER', 'SUPER_ADMIN', 'COMMITTEE_ADMIN'],
    },
    {
